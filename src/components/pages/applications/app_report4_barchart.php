<?php
    ...
    $left_selected = "APPREPORT4";
    $tabTitle = "APP Report 4";
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    function createPieChart(pieChart){
        ...
        switch(name){
            case 'Application':
                <?php
                $query = $db->query("SELECT DISTINCT app_status, COUNT(app_status) AS occurrences FROM (SELECT DISTINCT app_name, app_version, app_status from applications) as subquery group by app_status;");
