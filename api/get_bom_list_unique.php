<?php
     ...
     * 
     * Sample URL INPUTS:
     * http://localhost/sbom2/api/get_bom_list_unique.php?app_id=946907896
     * http://localhost/sbom2/api/get_bom_list_unique.php?app_name=GENERAL ED
     * http://localhost/sbom2/api/get_bom_list_unique.php?app_name=TechIF Adv
     * http://localhost/sbom2/api/get_bom_list_unique.php?app_name=Tech
     * http://localhost/sbom2/api/get_bom_list_unique.php?app_name=lt
     * http://localhost/sbom2/api/get_bom_list_unique.php?app_name=General%20Te&app_version=96.9
     * http://localhost/sbom2/api/get_bom_list_unique.php?app_name=lt&app_version=9.9
